...
VALUES (1, 1, 2017, 01, 1, parsedatetime('2017-01-01', 'yyyy-MM-dd'), parsedatetime('2017-01-15', 'yyyy-MM-dd'), 2, 200.00, 190.00, 10.00);

INSERT INTO paychecks (paycheck_id, company_id, year, month, bi_week, start_date, end_date, number_of_hours, gross_amount, net_pay, reimbursement) 
VALUES (2, 1, 2017, 01, 2, parsedatetime('2017-01-16', 'yyyy-MM-dd'), parsedatetime('2017-01-30', 'yyyy-MM-dd'), 3, 300.00, 260.00, 0.00);

INSERT INTO paychecks (paycheck_id, company_id, year, month, bi_week, start_date, end_date, number_of_hours, gross_amount, net_pay, reimbursement) 
VALUES (3, 1, 2017, 02, 1, parsedatetime('2017-02-01', 'yyyy-MM-dd'), parsedatetime('2017-02-15', 'yyyy-MM-dd'), 2, 200.00, 190.00, 10.00);

INSERT INTO paychecks (paycheck_id, company_id, year, month, bi_week, start_date, end_date, number_of_hours, gross_amount, net_pay, reimbursement) 
VALUES (4, 2, 2017, 02, 1, parsedatetime('2017-02-01', 'yyyy-MM-dd'), parsedatetime('2017-02-15', 'yyyy-MM-dd'), 4, 400.00, 370.00, 0.00);

INSERT INTO paychecks (paycheck_id, company_id, year, month, bi_week, start_date, end_date, number_of_hours, gross_amount, net_pay, reimbursement) 
VALUES (5, 2, 2017, 02, 2, parsedatetime('2017-02-16', 'yyyy-MM-dd'), parsedatetime('2017-02-28', 'yyyy-MM-dd'), 4, 400.00, 370.00, 0.00);
